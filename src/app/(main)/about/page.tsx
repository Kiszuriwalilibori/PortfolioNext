...
export default function About() {
    return (
        <>
            ...
            <Head>
                <link rel="preload" as="image" href="/mobile-backgrounds/aboutme.webp" media="(max-width: 767px)" type="image/webp" fetchPriority="high" />
                <link rel="preload" as="image" href="/backgrounds/aboutme.webp" media="(min-width: 768px)" type="image/webp" fetchPriority="high" />
            </Head>
