...
export const Comment = (props: Props) => {
    ...
    return (
        <CommentPaper>
            ...
            <CommentDivider />
            <CommentActions commentId={comment.ID} commentAuthorEmail={comment.authorEmail} projectID={projectID} projectTitle={projectTitle} commentContent={comment.content} />
        </CommentPaper>
    );
};
